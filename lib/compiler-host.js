System.register(['typescript', './logger', './utils', './libFiles'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var ts, logger_1, utils_1, libFiles_1;
        ...
        execute: function() {
            ...
            CompilerHost = (function () {
                ...
                CompilerHost.prototype.getDefaultLibFileName = function () {
                    return libFiles_1.getDefaultLibFilePaths(this._options)[0][0];
                };
