System.register(["typescript"], function (exports_1, context_1) {
    ...
    function translate(load) {
        ...
        return factory.then(function (_a) {
            var transpiler = _a.transpiler, resolver = _a.resolver, typeChecker = _a.typeChecker, host = _a.host, options = _a.options;
            ...
            if (isTypescriptDeclaration(load.address)) {
                ...
                var result = transpiler.transpile(load.address, options);
    ...
    function instantiate(load, systemInstantiate) {
        return factory.then(function (_a) {
            var typeChecker = _a.typeChecker, resolver = _a.resolver, host = _a.host, options = _a.options;
        ...
        return factory.then(function (_a) {
            ...
            if (options.typeCheck && isTypescript(load.address)) {
                return resolver.resolve(load.address, options)
                    .then(function (deps) {
                    var errors = typeChecker.check(options);
    ...
    function bundle() {
        if (!factory)
            return [];
        return factory.then(function (_a) {
            var typeChecker = _a.typeChecker, host = _a.host, options = _a.options;
            if (options.typeCheck) {
                var errors = typeChecker.forceCheck(options);
                formatErrors(errors, logger);
