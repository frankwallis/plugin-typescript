System.register(["typescript"], function (exports_1, context_1) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, typescript_1.extend(typescript_1.extend({ tsconfigAddress: tsconfigAddress, files: files }, sjsconfig), result.config.compilerOptions)];
    ...
    var typescript_1, Logger, __awaiter, __generator, typescriptRegex, javascriptRegex, mapRegex, declarationRegex, htmlRegex, logger$2, HTML_MODULE, CompilerHost, logger$3, Transpiler, logger$4, Resolver, logger$5, TypeChecker, logger$1, logger, factory;
    return {
        setters: [
            ...
            ***************************************************************************** */
            ...
            CompilerHost = (function () {
                ...
                CompilerHost.prototype.getDefaultLibFilePaths = function () {
                    ...
                    else if (this._options.targetLib === typescript_1.ScriptTarget.ES5)
