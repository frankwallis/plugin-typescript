System.register(["typescript"], function (exports_1, context_1) {
    ...
    var typescript_1, Logger, typescriptRegex, javascriptRegex, mapRegex, declarationRegex, htmlRegex, convertRegex, logger$2, HTML_MODULE, CompilerHost, logger$3, Transpiler, logger$4, Resolver, logger$5, TypeChecker, logger$1, logger, factory;
    return {
        setters: [
