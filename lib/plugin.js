System.register(["typescript"], function (exports_1, context_1) {
    ...
    var typescript_1, extendStatics, Logger, logger$2, typescriptRegex, javascriptRegex, jsxRegex, mapRegex, declarationRegex, convertRegex, logger$3, CompilerHost, logger$4, Transpiler, logger$5, Resolver, logger$6, TypeChecker, logger$1, logger, factory;
    return {
        setters: [
