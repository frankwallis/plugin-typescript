        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        tsconfigObj = _a.sent();
                        result = typescript_1["default"].parseConfigFileTextToJson(tsconfigAddress, JSON.stringify(tsconfigObj));
                        if (result.error) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (isTypescriptDeclaration(load.address)) {
                            if (loader.builder && (options.module == typescript_1["default"].ModuleKind.ES2015)) {
                                load.source = null;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (isJson(load.address)) {
                    ...
                    return [2, loader.registry && loader.registry.get('@empty')];
                }
                else {
