System.register(["typescript"], function (exports_1, context_1) {
    ...
    function getExtension(normalized) {
        var baseName = typescript_1["default"].getBaseFileName(normalized);
    ...
    function createFactory(sjsconfig, builder, _resolve, _fetch) {
        if (sjsconfig === void 0) {
            sjsconfig = {};
        }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        config = _a.sent();
                        return [4, createServices(config, builder, _resolve)];
                    case 2:
                        services = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        result = typescript_1["default"].parseConfigFileTextToJson(tsconfigAddress, tsconfigText);
                        if (result.error) {
                            formatErrors([result.error], logger$1);
                            throw new Error("failed to load tsconfig from " + tsconfigAddress);
                        }
                        files = result.config.files;
                        return [2, typescript_1["default"].extend(typescript_1["default"].extend({ tsconfigAddress: tsconfigAddress, files: files }, sjsconfig), result.config.compilerOptions)];
    ...
    function createServices(config, builder, _resolve) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        failOnError = !loader.build && (options.typeCheck === "strict");
    ...
    function validateOptions(options) {
        if ((options.module != typescript_1["default"].ModuleKind.System) && (options.module != typescript_1["default"].ModuleKind.ES2015)) {
            logger.warn("transpiling to " + typescript_1["default"].ModuleKind[options.module] + ", consider setting module: \"system\" in typescriptOptions to transpile directly to System.register format");
        }
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2, typescript_1["default"].normalizePath(normalized)];
                }
            });
        });
    }
    ...
    var typescript_1, extendStatics, Logger, logger$2, typescriptRegex, javascriptRegex, jsxRegex, mapRegex, declarationRegex, jsonRegex, convertRegex, logger$3, CompilerHost, logger$4, Transpiler, logger$5, Resolver, logger$6, TypeChecker, logger$1, logger, factory;
    return {
        setters: [
        ...
        execute: function () {
            ...
            Transpiler = (function () {
                ...
                Transpiler.prototype.transpile = function (sourceName, options) {
                    ...
                    if (!file.output) {
                        ...
                        var program = typescript_1["default"].createProgram([sourceName], transpileOptions, this._host);
            ...
            Resolver = (function () {
                function Resolver(host, resolve) {
                    this._host = host;
                ...
                Resolver.prototype.resolve = function (sourceName, options) {
                    ...
                    if (!file.pendingDependencies) {
                        var info = typescript_1["default"].preProcessFile(file.text, true);
                ...
                Resolver.prototype.lookupTyping = function (importName, sourceName, address, options) {
                    return __awaiter(this, void 0, void 0, function () {
                        var packageName, packageTypings, importTypings;
                        return __generator(this, function (_a) {
            ...
            TypeChecker = (function () {
                ...
                TypeChecker.prototype.getAllDiagnostics = function (candidates, typeCheckOptions) {
                    ...
                    var program = typescript_1["default"].createProgram(filelist, typeCheckOptions, this._host);
