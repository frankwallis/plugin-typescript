System.register(['typescript', './logger', './factory', './format-errors', './utils'], function(exports_1, context_1) {
    ...
    function instantiate1(load, systemInstantiate) {
        return factory.then(function (_a) {
            ...
            return systemInstantiate(load)
                ...
                resolver.resolve(load.address)
                    .then(function (deps) { return Promise.all(deps.list.filter(function (d) { return utils_1.isTypescript(d); })); })
                    .then(function () {
    ...
    exports_1("instantiate1", instantiate1);
    function instantiate4(load, systemInstantiate) {
        return factory.then(function (_a) {
            var typeChecker = _a.typeChecker, resolver = _a.resolver, host = _a.host;
            return systemInstantiate(load)
                .then(function (entry) {
    ...
    exports_1("instantiate4", instantiate4);
    function bundle() {
        if (!factory)
            return [];
        return factory.then(function (_a) {
