System.register(["typescript"], function (exports_1, context_1) {
    ...
    var typescript_1, Logger, logger$1, CompilerHost, logger$2, typescriptRegex, javascriptRegex, jsxRegex, mapRegex, declarationRegex, jsonRegex, logger$3, logger, host;
    return {
        setters: [
