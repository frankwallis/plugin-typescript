System.register(["typescript"], function (exports_1, context_1) {
    ...
    function convertErrors(diags) {
        return diags.reduce(function (result, diag) {
            ...
            result.push({
                ...
                category: typescript_1.DiagnosticCategory[diag.category],
                errorCode: diag.code
            });
            return result;
        }, []);
    ...
    function translate(load) {
        return __awaiter(this, void 0, void 0, function () {
            var loader, _a, transpiler, resolver, typeChecker, host, options, typeErrors, transpileErrors, result, failOnError, depslist;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4, resolveDependencies(load, resolver, options)];
                    case 2:
                        depslist = _b.sent();
                        return [4, typeCheck(load, typeChecker, options, failOnError)];
                    case 3:
                        typeErrors = _b.sent();
    ...
    function resolveDependencies(load, resolver, options) {
        return __awaiter(this, void 0, void 0, function () {
            var deps;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, resolver.resolve(load.address, options)];
                    case 1:
                        deps = _a.sent();
                        return [2, deps.list
    ...
    function typeCheck(load, typeChecker, options, failOnError) {
        return __awaiter(this, void 0, void 0, function () {
            var diags, errors;
            return __generator(this, function (_a) {
                diags = typeChecker.check(options);
                errors = convertErrors(diags);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!parent)
                            parent = __moduleName;
                        return [4, System.normalize(dep, parent)];
                    case 1:
                        normalized = _a.sent();
    ...
    function _fetch(address) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, System.fetch({ name: address, address: address, metadata: {} })];
                    case 1:
                        text = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        metadata = {};
                        return [4, System.locate({ name: address, address: address, metadata: metadata })];
                    case 1:
                        _a.sent();
