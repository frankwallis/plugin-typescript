        ...
        execute: function() {
            ...
            TypeChecker = (function () {
                ...
                TypeChecker.prototype.check = function () {
                    ...
                    if (candidates.some(function (candidate) { return !candidate.file.checked && candidate.checkable && !utils_1.isTypescriptDeclaration(candidate.name); }))
                ...
                TypeChecker.prototype.getCandidates = function (force) {
                    ...
                    var candidates = this._host.getAllFiles()
                        .filter(function (file) { return file.fileName != compiler_host_1.__HTML_MODULE__ && !file.isDefaultLibFile; })
