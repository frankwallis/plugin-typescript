        ...
        execute: function() {
            ...
            Resolver = (function () {
                ...
                Resolver.prototype.lookupTyping = function (importName, sourceName, address) {
                    var _this = this;
                    var typings = this._host.options.typings[importName];
                    if (typings) {
                        return this.resolveTyping(typings, importName, sourceName, address);
                    }
                    else {
                        return this._lookup(address)
                            .then(function (metadata) { return _this.resolveTyping(metadata.typings, importName, sourceName, address); });
                    }
                };
                Resolver.prototype.resolveTyping = function (typings, importName, sourceName, address) {
                    if (typings === true) {
