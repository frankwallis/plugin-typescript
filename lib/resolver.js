        ...
        execute: function() {
            ...
            Resolver = (function () {
                        ...
                        if (utils_1.isAmbientImport(importName) && utils_1.isJavaScript(resolvedImport)) {
                            if (!_this._typings[resolvedImport]) {
                                if (_this._host.options.typingsMap) {
                                    _this._typings[resolvedImport] = _this.resolveMappedTyping(importName, resolvedImport)
                                        .then(function (resolvedTyping) {
                                        return resolvedTyping ? resolvedTyping : resolvedImport;
                                    });
                                }
                                else if (_this._host.options.resolveTypings) {
                                    ...
                                    _this._typings[resolvedImport] = Promise.resolve(resolvedImport);
                                }
                            }
                ...
                Resolver.prototype.resolveMappedTyping = function (importName, resolvedImportName) {
                    var _this = this;
                    return Promise.resolve(Object.keys(this._host.options.typingsMap).reduce(function (result, key) {
                        if (_this._host.options.typingsMap[key] === true) {
                            ...
                            return _this._resolve("./" + _this._host.options.typingsMap[key], resolvedImportName.slice(0, -3) + '/index.js');
                        }
                        return result;
                    }, undefined));
                };
