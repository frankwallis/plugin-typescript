...
var isExternal = require('../lib/utils').isExternal;
...
describe( 'Utils', function () {
    ...
    describe( 'isExternal', function () {
        it('does not match absolute paths', function () {
            isExternal("/a/b.c").should.be.false;
            isExternal("/a/b").should.be.false;
        });
        ...
        it('matches external paths', function () {
            isExternal("b").should.be.true;
            isExternal("a/b.c").should.be.true;
        });
    });
});
